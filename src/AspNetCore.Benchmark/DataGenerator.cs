...
namespace MicroBenchmarks.Serializers
{
    ...
    {
        [ProtoMember(1)] [Key(0)] public virtual int Id { get; set; }
        [ProtoMember(2)] [Key(1)] public virtual string Address1 { get; set; }
        [ProtoMember(3)] [Key(2)] public virtual string Address2 { get; set; }
        [ProtoMember(4)] [Key(3)] public virtual string City { get; set; }
        [ProtoMember(5)] [Key(4)] public virtual string State { get; set; }
        [ProtoMember(6)] [Key(5)] public virtual string PostalCode { get; set; }
        [ProtoMember(7)] [Key(6)] public virtual string Name { get; set; }
        [ProtoMember(8)] [Key(7)] public virtual string PhoneNumber { get; set; }
        [ProtoMember(9)] [Key(8)] public virtual string Country { get; set; }
    }
    ...
    public class ActiveOrUpcomingCampaign
    {
        ...
        [ProtoMember(5)] [Key(4)] public DateTime StartDate { get; set; }
        [ProtoMember(6)] [Key(5)] public DateTime EndDate { get; set; }
    }
    ...
    public class ActiveOrUpcomingEvent
    {
        ...
        [ProtoMember(7)] [Key(6)] public DateTime StartDate { get; set; }
        [ProtoMember(8)] [Key(7)] public DateTime EndDate { get; set; }
    }
    ...
    {
        [ProtoMember(1)] [Key(0)] public virtual List<ActiveOrUpcomingEvent> ActiveOrUpcomingEvents { get; set; }
        [ProtoMember(2)] [Key(1)] public virtual CampaignSummaryViewModel FeaturedCampaign { get; set; }
        [ProtoMember(3)] [Key(2)] public virtual bool IsNewAccount { get; set; }
    ...
    public class MyEventsListerItem
    {
        ...
        [ProtoMember(3)] [Key(2)] public DateTime StartDate { get; set; }
        [ProtoMember(4)] [Key(3)] public DateTime EndDate { get; set; }
    ...
    {
        [ProtoMember(1)] [Key(0)] public virtual string Name { get; set; }
        [ProtoMember(2)] [Key(1)] public virtual DateTime? StartDate { get; set; }
        [ProtoMember(3)] [Key(2)] public virtual DateTime? EndDate { get; set; }
